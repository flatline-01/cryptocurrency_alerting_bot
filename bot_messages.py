...
PROVIDE_ALERT_ID = 'Provide an alert id:'
...
SPECIFY_PRICE_OR_PERCENT = 'Do you want to specify the price in dollars or the percentage by which it will change?'
...
NO_SUCH_CURRENCY = 'Currency is not supported or doesn\'t exist.'
INVALID_PRICE = 'The price of the currency cannot be less than or equal to zero.'
INVALID_DELAY = 'The delay cannot be less than or equal to zero.'
